...
$products = [
    ...
    ['name'=>'Steam Gift Card R50','slug'=>'steam-gift-card-50','description'=>'Gift Card digital para adicionar saldo na sua conta Steam.','price'=>52.00,'status'=>'active'],
    ...
    ['name'=>'VPN NordVPN 1 Ano','slug'=>'vpn-nordvpn-1-ano','description'=>'Privacidade e seguranca online com NordVPN por 12 meses em ate 6 dispositivos.','price'=>99.90,'status'=>'active'],
...
echo 'Produtos ativos: ' . DB::table('products')->where('status','active')->count() . PHP_EOL;
